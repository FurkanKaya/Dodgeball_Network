    ...
    public void run() {
        ...
        while(true)
        {
            try
            {
                ...
                // oyun için gerekli sayaçları ve değişkenleri düzenle
                selectedPlayer.isHoldingBall=true;
                myGame.ballsInPlay++;
                ...
                {
                    if(myGame.players[i].isHoldingBall)
                    {
                        myFrame.sendSendableListTo(myGame.players[i]);
                    }
                }
